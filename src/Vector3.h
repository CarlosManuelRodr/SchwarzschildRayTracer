...
/**
 * @class Vector3
 * @brief Three-component, single-precision Cartesian vector.
 */
class Vector3
{
public:
...
/** @brief Normalize a nonzero vector. This historical helper does not guard a zero length. */
inline Vector3 unit_vector(Vector3 v)
{
    return v / v.Length();
}

/** @brief Rejection-sample a point within the unit ball using RandomGen. */
